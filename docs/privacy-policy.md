...
- __Application__ refers to StorageFlow, the software program provided by the Company.



- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to StorageFlow.
...
- By visiting this page on our website: [https://github.com/varundeva/storageflow/issues](https://github.com/varundeva/storageflow/issues)